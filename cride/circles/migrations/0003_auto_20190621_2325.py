...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0001_initial'),
        ('circles', '0002_auto_20190612_2350'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text="circle admin can update data and manage it's membership", verbose_name='circle admin')),
                ...
                ('is_active', models.BooleanField(default=True, help_text='Only active users are allowed to interact with the circle', verbose_name='active status')),
